...
def create_self_signed_cert(cert_file, key_file, client_tag):
	...
	cert.get_subject().OU = "The ICLab Client (" + client_tag + ")" #raw_input("Organizational Unit: ")
...
#	create_self_signed_cert(conf['client_certificate'], conf['client_key'])
